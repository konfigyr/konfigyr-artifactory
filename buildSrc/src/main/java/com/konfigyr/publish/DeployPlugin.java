...
public class DeployPlugin implements Plugin<Project> {
	...
	private void customizePom(MavenPom pom, Project project) {
		pom.getUrl().set("https://github.com/konfigyr/konfigyr-artifactory");
		...
		pom.issueManagement(issue -> {
			...
			issue.getUrl().set("https://github.com/konfigyr/konfigyr-artifactory/issues");
		});
		pom.scm(scm -> {
			scm.getDeveloperConnection().set("scm:git:ssh://git@github.com/konfigyr/konfigyr-artifactory.git");
			scm.getConnection().set("scm:git:git://github.com/konfigyr/konfigyr-artifactory.git");
			scm.getUrl().set("https://github.com/konfigyr/konfigyr-artifactory");
