# Contributing to Konfigyr Artifactory SDK

Konfigyr Artifactory SDK is released under the Apache 2.0 license.
If you would like to contribute something, or simply want to hack on the code this document should help you [get started](https://github.com/konfigyr/konfigyr-artifactory#getting-started).

## Code of Conduct
This project adheres to the Contributor Covenant [code of conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code.

## Using GitHub Issues
We use [GitHub issues](https://github.com/konfigyr/konfigyr-artifactory/issues) to track bugs and enhancements.
